...
def floor_svg(floor: dict, title: str) -> str:
    ...
    <svg class="plan-svg" viewBox="0 0 {width} {height}" role="img" aria-label="{esc(title)}">
      ...
      {''.join(shapes)}
      <text x="70" y="708" class="note">Green dashed line = simple coordinate-derived envelope; spaces are preliminary planning rectangles.</text>
    </svg>
    """
...
<section class="page">
  ...
  <p class="sub">A coordinated planning package for a ground-floor Bar Association hall and first-floor Bar Library, derived from the stored L-shaped plot geometry and the room schedule in the repository.</p>
  <hr class="rule">
  <div class="grid">
  ...
  <ul>
    ...
    <li>Ground-floor hall, reception, stair, pantry, toilets, and dais plan</li>
    <li>First-floor library, stack, admin, discussion, computer, and service-core plan</li>
...
<section class="page">
  ...
  <p>South entry and reception lead into the service core and the upper hall. The west zero-setback edge is shown as a blank wall; the east-side exit remains a review placeholder.</p>
...
<section class="page">
  ...
  <p>The stair, pantry, and wet areas are stacked over the ground-floor service core. Reading and stack zones occupy the upper wing; shelving loads and escape capacity require engineering review.</p>
