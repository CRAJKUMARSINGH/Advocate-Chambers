...
**Revision:** A  |  **Status:** Preliminary review  |  **Units:** Feet

> This is a coordinated planning study, not a construction drawing, approval drawing, fire NOC drawing, or structural design. Have the final scheme checked against a site survey, local bylaws, NBC/RPwD requirements, fire strategy, structure, and services.
...
| --- | --- | --- | --- | ---: |
| GF-01 | Reception / Records | (0, 5) | 11' x 16'-6" | 181.5 sq ft |
| GF-02 | Stair Core | (11, 5) | 10' x 9' | 90 sq ft |
| GF-03 | Pantry | (11, 14) | 10' x 7'-6" | 75 sq ft |
| GF-04 | Toilet Block | (21, 5) | 9' x 16'-6" | 148.5 sq ft |
| GF-05 | Main Assembly Hall | (0, 21.5) | 55' x 57' | 3,135 sq ft |
| GF-06 | Dais / Speaker Zone | (0, 78.5) | 55' x 14'-6" | 797.5 sq ft |
| | **Total** | | | **4,427.5 sq ft** |
...
| ID | Space | Coordinates (x, y) | Size | Area |
| --- | --- | --- | --- | ---: |
| FF-01 | Librarian / Admin | (0, 5) | 11' x 16'-6" | 181.5 sq ft |
| FF-02 | Stair Core | (11, 5) | 10' x 9' | 90 sq ft |
| FF-03 | Pantry | (11, 14) | 10' x 7'-6" | 75 sq ft |
| FF-04 | Toilet Block | (21, 5) | 9' x 16'-6" | 148.5 sq ft |
| FF-05 | Library Reading Room | (0, 21.5) | 55' x 43' | 2,365 sq ft |
| FF-06 | Stack Area / Book Storage | (0, 64.5) | 55' x 18' | 990 sq ft |
| FF-07 | Discussion Room | (0, 82.5) | 18' x 10'-6" | 189 sq ft |
| FF-08 | Computer / Internet | (18, 82.5) | 18' x 10'-6" | 189 sq ft |
| FF-09 | Store / Electrical | (36, 82.5) | 19' x 10'-6" | 199.5 sq ft |
| | **Total** | | | **4,427.5 sq ft** |

## Decisions carried into this revision

1. The main public entry is at the south, through a reception/records vestibule.
2. The stair, pantry, and toilet block are aligned between floors to reduce service complexity.
3. The west zero-setback wall is shown without openings.
4. The ground-floor hall has a central aisle and northern dais; the first floor keeps the same upper-wing footprint for a flexible reading room and stack zone.
5. An east-side exit is marked as a review placeholder, not as an approved fire exit.
...
- Confirm occupant capacity, number and width of exits, travel distances, stair width, accessible route, and toilet clearances.
